...
async def energyLegitCheck(acuClass, SequenceId, Display, Control, MeterModel):
    ...
    if (SequenceId == 1):
        ...
        if (await ReadingComparator(acuClass, contents, start_address, len(contents))):
            ...
            SequenceId == 6 and MeterModel in 'A'):  # current meter will have problem in manual edit mode, subject to change based on meter release
        # TODO
...
async def EnergyMemoryRetention(acuClass, WaitControl):
    ...
    try:
        assert Energy == [3167, 20, 2134, 0, 2052, 0, 5787, 1, 5302, 20, 1033, 20, 1286, 2, 6553, 2, 2819, 21, 6274, 21,
                          1894, 1,
                          2718, 21, 2192, 7, 0, 0, 0, 0, 0, 0, 0, 0, 6, 47, 0, 677, 655, 522, 0, 120, 6, 634, 0, 251, 0,
                          32, 4936, 49, 0, 117, 3567, 0,
    ...
    try:
        assert Energy == [3167, 20, 2134, 0, 2052, 0, 5787, 1, 5302, 20, 1033, 20, 1286, 2, 6553, 2,
                          2819, 21, 6274, 21, 1894, 1, 2718, 21, 2192, 7, 0, 0, 0, 0, 0, 0, 0, 0, 6, 47, 0, 677, 655,
                          522, 0, 120, 6, 634, 0, 251, 0, 32,
